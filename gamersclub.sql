...
--
-- Host: localhost
-- Generation Time: Jan 07, 2010 at 05:00 PM
...
CREATE TABLE IF NOT EXISTS `games` (
  ...
  `download` tinytext,
  `addDate` int(50) DEFAULT NULL,
  `createDate` int(50) DEFAULT NULL,
